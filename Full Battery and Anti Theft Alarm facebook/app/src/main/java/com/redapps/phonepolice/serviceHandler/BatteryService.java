...
public class BatteryService extends Service {
    private static final String NOTIFY_CHANNEL_ID = "BatteryBackgroundService";
    DbHelper dbHelper;
    ...
    private void startForeground() {
        ...
        remoteViews.setTextViewText(R.id.text_view_collapsed_2, getString(R.string.fullBatterAlerisActive));
        ...
        startForeground(2, new NotificationCompat.Builder(this, NOTIFY_CHANNEL_ID).setOngoing(true).setColor(-1).setSmallIcon(R.mipmap.ic_launcher).setCustomContentView(remoteViews).setContentIntent(activity).build());
    }
    ...
    public void createChargerBroadcast() {
        ...
        BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                Vibrator vibrator = (Vibrator) BatteryService.this.getSystemService(VIBRATOR_SERVICE);
                if (intExtra >= 100) {
                    if (Constants.Light_Status.booleanValue()) {
                        BatteryService.this.setFlash(true);
                    }
                ...
                if (Constants.Light_Status.booleanValue()) {
                    BatteryService.this.setFlash(false);
                }
                vibrator.cancel();
